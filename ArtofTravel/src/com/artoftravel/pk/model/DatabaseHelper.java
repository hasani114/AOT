...
public class DatabaseHelper {
	...
	public void tourUpdate(TourModel tour) {
	...
	try{  
		...
		PreparedStatement stmt=con.prepareStatement("INSERT INTO tour_details (tour_name, tour_location, tour_country, group_size, tour_price, tour_duration, tour_description) VALUES (?, ?, ?, ?, ?, ?, ?)");  
